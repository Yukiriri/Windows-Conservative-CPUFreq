for %%i in (SetAcValueIndex SetDcValueIndex) do (
    ...
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin 33
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin1 33
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin2 33
