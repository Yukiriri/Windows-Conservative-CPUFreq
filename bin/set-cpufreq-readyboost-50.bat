for %%i in (SetAcValueIndex SetDcValueIndex) do (
    ...
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin 50
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin1 50
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin2 50
