for %%i in (SetAcValueIndex SetDcValueIndex) do (
    ...
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin 75
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin1 75
    powercfg -%%i Scheme_Current Sub_Processor ProcThrottleMin2 75
